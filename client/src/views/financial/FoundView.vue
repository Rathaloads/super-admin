	...
	<div class="list-view rounded-[12px] bg-white">
		<div class="list-view">
			...
			<div class="list-view-footer">
				<el-pagination v-model:current-page="pagination.currentPage" v-model:page-size="pagination.pageSize" :total="pagination.total" layout="prev, pager, next" @current-change="handleCurrentChange" @size-change="handleSizeChange" />
			</div>
		</div>
	</div>
</template>
